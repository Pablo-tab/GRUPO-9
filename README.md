...
def menu_principal():
    while True:
        ...
        if opcion == "1":
            ...
            menu_clientes() # Abre modulo clientes 
        elif opcion == "2":
            print("\nAccediendo a Gestión de Destinos...")
            menu_destinos() # Abre menu destinos
        elif opcion == "3":
            ...
            menu_ventas() # Abre menu ventas
                    ...
                    print("Versión 1.0 - año 2025 - TODOS LOS DERECHOS RESERVADOS")
                    print("Prototipo no funcional con estructuración clara.")
        elif opcion == "5":
